...
export const COMPREHENSIVE_NAMES = [
  ...
  'kofi', 'kolade', 'konstantin', 'kwame', 'kyle', 'kola',
  // L
  ...
  'zoya', 'zubair', 'zuri',
  // Extended additions
  'abdullah', 'abraham', 'abram', 'adelaide', 'adeline', 'agnes', 'ahmad', 'alaina', 'alana', 'alejandro', 'alexis', 'alfred', 'alicia', 'aline', 'alison', 'allison', 'alma', 'alvin', 'amber', 'amelia', 'andre', 'angel', 'angelica', 'anita', 'annabelle', 'annette', 'archie', 'ari', 'ariana', 'ariel', 'armand', 'arnold', 'ashleigh', 'astrid', 'audrey', 'aurora', 'avery', 'barry', 'becky', 'benedict', 'benny', 'bernice', 'blair', 'boaz', 'brad', 'bradley', 'brett', 'brianna', 'bridget', 'brooke', 'calvin', 'candace', 'candy', 'carla', 'carlton', 'casey', 'cassidy', 'cedric', 'celeste', 'celia', 'charlie', 'chase', 'chelsea', 'clark', 'claudia', 'cody', 'cole', 'colleen', 'cora', 'corey', 'courtney', 'crystal', 'daisy', 'dakota', 'daphne', 'darrell', 'darren', 'daryl', 'dean', 'delia', 'demi', 'denise', 'desmond', 'devon', 'dominique', 'doris', 'drake', 'drew', 'duke', 'duncan', 'eden', 'edwin', 'eleanor', 'elise', 'elsie', 'elvis', 'emmanuel', 'enoch', 'erica', 'errol', 'evan', 'eve', 'felicia', 'finley', 'floyd', 'francisca', 'frankie', 'gabriella', 'geoffrey', 'geraldine', 'gillian', 'giulia', 'gordon', 'guadalupe', 'gwendolyn', 'harvey', 'heidi', 'hunter', 'isabel', 'jackie', 'jacqueline', 'jared', 'jasper', 'jayden', 'jennie', 'jill', 'jimmy', 'jonas', 'josef', 'joyce', 'judy', 'kaden', 'kaitlyn', 'karl', 'kendra', 'kieran', 'kingsley', 'leonardo', 'lexi', 'lola', 'lorraine', 'maddison', 'madeline', 'maggie', 'marcel', 'marceline', 'marco', 'mariah', 'marina', 'marvin', 'max', 'maxwell', 'melanie', 'melvin', 'meredith', 'micah', 'miles', 'miranda', 'naira', 'nana', 'natalie', 'nathaniel', 'nehemiah', 'nichole', 'nigel', 'orlando', 'parker', 'phoenix', 'raina', 'ramsey', 'reagan', 'reuben', 'riley', 'sabrina', 'samira', 'sasha', 'savannah', 'scarlett', 'selena', 'serena', 'shawn', 'simon', 'simeon', 'skye', 'sloane', 'spencer', 'summer', 'tabitha', 'talia', 'tanner', 'terrence', 'theodore', 'tia', 'tiffany', 'tristan', 'valentine', 'vernon', 'whitney', 'xenia', 'yasmine', 'zachariah', 'zain', 'zephaniah', 'zion',
];
...
export const COMPREHENSIVE_PLACES = [
  ...
  'zurich',
  // Extended additions
  'aberdeen', 'abkhazia', 'adana', 'aden', 'adriatic', 'africa', 'agadez', 'ahmedabad', 'ajman', 'alabama', 'alexandria', 'almaty', 'amman', 'amritsar', 'andaman', 'antwerp', 'appalachia', 'aruba', 'ashgabat', 'asmara', 'astana', 'asuncion', 'athabasca', 'atlantic', 'austin', 'avignon', 'badajoz', 'baffin', 'baltic', 'bandung', 'bangui', 'basel', 'baton rouge', 'belmopan', 'benin city', 'benghazi', 'bhopal', 'bilbao', 'bissau', 'blantyre', 'bloemfontein', 'bridgetown', 'bujumbura', 'cali', 'cambridge', 'cape verde', 'cartagena', 'cayman islands', 'central african republic', 'christchurch', 'cincinnati', 'cotonou', 'crete', 'curacao', 'dar es salaam', 'darwin', 'dominican republic', 'douala', 'dushanbe', 'east timor', 'essen', 'evansville', 'exeter', 'faisalabad', 'falkland islands', 'faroe islands', 'fez', 'flint', 'fortaleza', 'fribourg', 'gaborone', 'gaza', 'georgetown', 'graz', 'guadalajara', 'guangzhou', 'guernsey', 'hamilton', 'hangzhou', 'hannover', 'herzegovina', 'hilo', 'hobart', 'ibiza', 'indore', 'innsbruck', 'isfahan', 'jammu', 'jilin', 'juneau', 'kairouan', 'kanpur', 'karlsruhe', 'kashmir', 'kharkiv', 'kingstown', 'kirkuk', 'la paz', 'lancashire', 'lanzarote', 'las vegas', 'leicester', 'lille', 'limpopo', 'lome', 'lugano', 'malabo', 'malaga', 'malmo', 'mandalay', 'maracaibo', 'marrakesh', 'massachusetts', 'matola', 'mbabane', 'medan', 'merida', 'mombasa', 'monrovia', 'marrakech', 'nagaland', 'new jersey', 'new mexico', 'new orleans', 'new york', 'new zealand', 'niamey', 'nicosia', 'nile', 'orlando', 'ouagadougou', 'panama city', 'parma', 'peshawar', 'pittsburgh', 'plovdiv', 'porto', 'reunion', 'salvador', 'samarkand', 'san antonio', 'san jose', 'san juan', 'santa fe', 'santo domingo', 'shenzhen', 'sichuan', 'sochi', 'stavanger', 'tenerife', 'uttarakhand', 'valletta', 'venezia', 'victoria falls', 'wroclaw', 'xining', 'yogyakarta', 'zadar', 'zanzibar city', 'zhenjiang', 'zhuhai',
];
...
export const COMPREHENSIVE_ANIMALS = [
  ...
  // Extended additions
  'abalone', 'agama', 'alewife', 'alligator gar', 'amphibian', 'anole', 'arctic fox', 'arctic hare', 'asp', 'auk', 'auklet', 'babirusa', 'barbel', 'barnacle', 'basilisk', 'beluga', 'bilby', 'bird', 'bird of paradise', 'blue jay', 'blue whale', 'booby', 'bonobo', 'brook trout', 'caiman', 'calf', 'camel spider', 'caracal', 'cassowary', 'catbird', 'cavy', 'chamois', 'chevrotain', 'cichlid', 'coati', 'cockle', 'cormorant', 'coucal', 'cuttlefish', 'dace', 'degu', 'dik-dik', 'dotterel', 'dragonet', 'drongo', 'dunlin', 'duiker', 'earthstar', 'earwig', 'eider', 'elephant seal', 'field mouse', 'fin whale', 'fisher', 'flicker', 'fossa', 'fruit bat', 'fruit fly', 'galago', 'gar', 'gargoyle gecko', 'gator', 'gharial', 'glowworm', 'goby', 'golden eagle', 'goshawk', 'grayling', 'grebe', 'grison', 'groundhog', 'guanaco', 'guar', 'guillemot', 'guinea fowl', 'gyrfalcon', 'hagfish', 'hammerhead', 'hartebeest', 'harvestman', 'hawk moth', 'hermit crab', 'herring gull', 'hoatzin', 'hoopoe', 'jackdaw', 'jaguarundi', 'jaybird', 'joey', 'kestrel', 'killdeer', 'king cobra', 'king crab', 'kinkajou', 'leafbird', 'leafhopper', 'leech', 'leopard seal', 'lionfish', 'louse', 'lungfish', 'mantid', 'marlin', 'mastodon', 'mayfly', 'mole crab', 'monarch butterfly', 'monitor lizard', 'moray eel', 'mudskipper', 'musk deer', 'musk ox', 'myotis', 'nautilus', 'newfoundland', 'nighthawk', 'oilbird', 'olm', 'pademelon', 'parakeet', 'peafowl', 'pelican eel', 'pilot whale', 'pintail', 'potoo', 'prairie dog', 'praying mantis', 'puff adder', 'quagga', 'quailfish', 'rabbitfish', 'raccoon dog', 'ragworm', 'ratfish', 'red panda', 'rockfish', 'rook', 'sable', 'sailfish', 'saiga', 'sand dollar', 'sandpiper', 'sapsucker', 'sawfish', 'scoter', 'sea lion', 'sea otter', 'sea snake', 'serpent', 'shrike', 'silverfish', 'skate', 'skink', 'smelt', 'snow leopard', 'snowy owl', 'sole', 'springbok', 'sturgeon', 'sunfish', 'suricate', 'swallow', 'swordtail', 'takin', 'tapeworm', 'tarsier', 'tench', 'thornback', 'thrush', 'tick', 'tiger shark', 'tit', 'tree frog', 'trilobite', 'tsetse fly', 'tuatara', 'turaco', 'turbot', 'unicornfish', 'vampire bat', 'vampire squid', 'wagtail', 'water buffalo', 'waterbuck', 'water vole', 'waxwing', 'whippoorwill', 'wild boar', 'wildcat', 'wolf spider', 'woolly monkey', 'wrasse', 'x-ray tetra', 'xerus squirrel', 'yellow perch', 'yeti crab', 'zebra shark', 'zebra finch',
];
...
export const COMPREHENSIVE_THINGS = [
  ...
  // Extended additions
  'air conditioner', 'air fryer', 'air mattress', 'alarm clock', 'almanac', 'amplifier', 'arcade machine', 'atlas', 'awning', 'backhoe', 'badge', 'badminton racket', 'barometer', 'baseball', 'baseball bat', 'basketball', 'bedsheet', 'bin', 'binder', 'blackboard', 'blinds', 'blow dryer', 'blueprint', 'boomerang', 'bookshelf', 'bottle opener', 'bow', 'bowtie', 'brace', 'brochure', 'buckle', 'bullhorn', 'bunk bed', 'cage', 'camerabag', 'cannister', 'card', 'cardboard', 'carriage', 'cash register', 'cassette', 'cello', 'cement mixer', 'clipboard', 'coaster', 'coffee maker', 'coffee table', 'combination lock', 'console', 'cookie cutter', 'cooler', 'cradle', 'crutch', 'cupboard', 'cutlery', 'cymbal', 'djembe', 'doormat', 'dumbbell', 'dustbin', 'e-reader', 'electric fan', 'electric kettle', 'extension cord', 'file cabinet', 'fire extinguisher', 'fireplace', 'fishing rod', 'flagpole', 'flash drive', 'folding chair', 'footstool', 'football', 'frisbee', 'gamepad', 'garbage can', 'garden hose', 'gas cooker', 'gavel', 'gift box', 'glue gun', 'grinder', 'hairbrush', 'hairdryer', 'hand mirror', 'handkerchief', 'hard drive', 'haversack', 'headboard', 'headset', 'highlighter', 'hockey stick', 'hula hoop', 'ice tray', 'ink pen', 'intercom', 'jack', 'jigsaw puzzle', 'keyring', 'kitchen sink', 'lawn chair', 'leather', 'lollipop', 'loudspeaker', 'mailbag', 'mannequin', 'measuring cup', 'measuring tape', 'memory card', 'mop bucket', 'mousepad', 'music box', 'notepad', 'oil lamp', 'paint roller', 'palette', 'paperclip', 'paperweight', 'parasol', 'pedal', 'pencil case', 'periscope', 'picnic basket', 'ping-pong paddle', 'pocketknife', 'polaroid camera', 'power bank', 'power drill', 'printer cartridge', 'projector screen', 'puncher', 'raincoat', 'rattle', 'record player', 'reel', 'rocking chair', 'roller skates', 'rolling pin', 'sackcloth', 'safety pin', 'sandbag', 'satnav', 'scooping net', 'sewing machine', 'shaving brush', 'shopping cart', 'sideboard', 'sketchbook', 'sleeping bag', 'slingshot', 'snowboard', 'spatula', 'spool', 'sprinkler', 'stapler remover', 'stepladder', 'surfboard', 'swimsuit', 'tablecloth', 'tack', 'tambourine', 'thermostat', 'thumbtack', 'toothpaste', 'tool', 'toolkit', 'torchlight', 'trash can', 'trellis', 'tuning fork', 'turntable', 'vacuum cleaner', 'waffle iron', 'walking stick', 'washbasin', 'water bottle', 'water filter', 'webcam', 'weighing scale', 'wheelchair', 'whiteboard', 'windshield', 'windowpane', 'wireless mouse', 'wooden spoon', 'workbench', 'yo-yo', 'zip bag', 'zip tie', 'zoo cage',
];
